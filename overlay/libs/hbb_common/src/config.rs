...
pub mod keys {
    ...
    // When enabled, client ignores user-modified server core links and only uses built-in values.
    pub const OPTION_FORCE_BUILTIN_SERVER: &str = "force-builtin-server";
    // Runtime bootstrap package code for customized client distributions.
    pub const OPTION_RUNTIME_PACKAGE_CODE: &str = "runtime-package-code";
    // Backward-compatible alias for RuntimeOps package code.
    pub const OPTION_REMOTEOPS_PACKAGE_CODE: &str = "remoteops-package-code";
    // Full bootstrap endpoint URL shipped in the signed custom client payload.
    pub const OPTION_RUNTIME_BOOTSTRAP_URL: &str = "runtime-bootstrap-url";
    // Backward-compatible alias for RuntimeOps bootstrap URL.
    pub const OPTION_REMOTEOPS_BOOTSTRAP_URL: &str = "remoteops-bootstrap-url";
    // Relative bootstrap endpoint URI shipped in the signed custom client payload.
    pub const OPTION_RUNTIME_BOOTSTRAP_URI: &str = "runtime-bootstrap-uri";
    // Backward-compatible alias for RuntimeOps bootstrap URI.
    pub const OPTION_REMOTEOPS_BOOTSTRAP_URI: &str = "remoteops-bootstrap-uri";
    ...
    pub const KEYS_BUILDIN_SETTINGS: &[&str] = &[
        ...
        OPTION_FORCE_BUILTIN_SERVER,
        OPTION_RUNTIME_PACKAGE_CODE,
        OPTION_REMOTEOPS_PACKAGE_CODE,
        OPTION_RUNTIME_BOOTSTRAP_URL,
        OPTION_REMOTEOPS_BOOTSTRAP_URL,
        OPTION_RUNTIME_BOOTSTRAP_URI,
        OPTION_REMOTEOPS_BOOTSTRAP_URI,
